...
<div class="container_right_href">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li class="hidden">
                        <a href="#page-top"></a>
                        <li><%-- <a href="/signIn"> <i class="fa fa-edit"></i>Logged in as : <%=userName %></a></li> --%><br>
        ...
        <div class="container">
          ...
          <div align="center">
                <div class="col-lg-12 text-center">
                    ...
                    <h3><i>Thanks for using onlineShoppe!</i></h3>
...
<div class="row">
                ...
                <div class="col-lg-12 text-center">
                    ...
                    <h4>Register here if you would like to continue shopping</h4>
                    <hr class="star-primary">
                </div>
            </div>
...
<div class="row">
			...
			<form id="form" method="post" action="/onlineshoppe/signup" novalidate="novalidate">
