        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12 text-center">
                    ...
                    <h3>Are you sure, you want to unsubscribe from OnlineShoppe</h3>
...
<div class="row">
			...
			<form id="form" method="post" action="${user.id }" novalidate="novalidate">

 <!-- <div class="row control-group" > -->
											<!-- <div class="row"> -->
                           <!--  <div class="form-group col-xs-12"> -->
                           <div align="center">
                           <button class="btn btn-success btn-lg"  type="submit">Unsubscribe</button>
                           </div>
