                ...
                <div class="col-lg-8 col-lg-offset-2" >
                    ...
                    <!-- The form should work on most web servers, but if the form is not working you may need to configure your web server differently. -->
                      ...
                      <ul class="list-unstyled" style="line-height: 2">
                          <li><span class="fa fa-pencil "></span><b> Forgot password ? </b></li>
                          <li><span class="fa fa-pencil "></span> <b>Click below to reset</b></li>
                          </ul>
                      <p><a href="/onlineshoppe/resetPassword" class="btn btn-danger btn-lg"><b>Reset Password</b></a></p>
                  </div>
                    </form>
                </div>
            </div>
